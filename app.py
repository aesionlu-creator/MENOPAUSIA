    ...
    function generarInformeApp() {
      ...
      if (absCount > 0) {
        ...
        if (document.getElementById('se-osteo')?.checked) recFinal += '\n* Antecedente de Endometriosis/Adenomiosis: Utilizar esquema COMBINADO CONTINUO o DIU Mirena.';
            ...
            const informeTexto = `
================================================================================
                    INFORME CLÍNICO DE EVALUACIÓN MENOPÁUSICA
                   Plataforma Integrada de Salud Femenina
================================================================================
...
3. VALORACIÓN DE SÍNTOMAS VASOMOTORES (BOCHORNOS)
--------------------------------------------------------------------------------
• Frecuencia : ${bDia} episodios/día | Impacto: ${bImp}/10 (${interpImp})
• Criterios  : Sudoración nocturna [${sudor}] | Despierta por la noche [${noche}]
               Interrumpe actividades [${act}] | Requiere cambio de ropa [${ropa}]

4. EVALUACIÓN DE CONTRAINDICACIONES (THM)
--------------------------------------------------------------------------------
• Absolutas : ${absText}
• Relativas : ${relText}
...
• Cáncer de Mama  : ${rMama} pts

  RIESGO GLOBAL    : ${rTotal} pts --> ${interpRiesgo}

6. CONDICIONES Y SITUACIONES ESPECIALES
--------------------------------------------------------------------------------
${sitEspText}

7. PREFERENCIA EXPRESA DE LA PACIENTE
--------------------------------------------------------------------------------
${pref}

================================================================================
8. CONDUCTA Y RECOMENDACIÓN CLÍNICA FINAL
================================================================================
Puntaje de Criterios Elegibles: ${indPuntos}/8 (${interpInd})
